...
Nota: se han usado los datos de BCB proporcionados en el repositorio de ASTNN (citado en el README.md principal del repositorio). En el trabajo de ASTNN se aplicó una reducción de BCB mitigando el desbalanceo entre clases.